import { version as version$1, unref, inject, hasInjectionContext, ref, toRef, getCurrentInstance, onServerPrefetch, defineAsyncComponent, useSSRContext, createApp, reactive, provide, onErrorCaptured, createVNode, resolveDynamicComponent, shallowRef, shallowReactive, isReadonly, isRef, isShallow, isReactive, toRaw, withCtx, mergeProps, nextTick, defineComponent, computed, h, Suspense, Transition } from 'vue';
import { h as useRuntimeConfig$1, n as withQuery, o as hasProtocol, p as parseURL, q as isScriptProtocol, j as joinURL, k as createError$1, r as hash, $ as $fetch, t as sanitizeStatusCode, v as createHooks, x as parse, y as getRequestHeader, z as isEqual, A as setCookie, B as getCookie, C as deleteCookie, D as getRequestHeaders, E as defu } from '../nitro/node-server.mjs';
import { getActiveHead } from 'unhead';
import { defineHeadPlugin } from '@unhead/shared';
import { createMemoryHistory, createRouter, START_LOCATION, useRoute as useRoute$1, RouterView } from 'vue-router';
import { __assign, __spreadArray, __extends, __rest, __awaiter, __generator } from 'tslib';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./assets/404-b88feb4e.mjs').then((m) => m.default || m)
  },
  {
    name: "collection",
    path: "/collection",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./assets/collection-060369b0.mjs').then((m) => m.default || m)
  },
  {
    name: "games-slug",
    path: "/games/:slug()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./assets/_slug_-c3d8d7bf.mjs').then((m) => m.default || m)
  },
  {
    name: "games",
    path: "/games",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./assets/index-69e6723e.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./assets/index-63ff644f.mjs').then((m) => m.default || m)
  }
];
...
const LazySvgoFooterGithub = defineAsyncComponent(() => import('./assets/github-45af7e9c.mjs').then((r) => r.default));
const LazySvgoFooterInsta = defineAsyncComponent(() => import('./assets/insta-5bfa9dac.mjs').then((r) => r.default));
const LazySvgoFooterLinktree = defineAsyncComponent(() => import('./assets/linktree-201fc3e4.mjs').then((r) => r.default));
const LazySvgoFooterSpotify = defineAsyncComponent(() => import('./assets/spotify-cddeb190.mjs').then((r) => r.default));
const LazySvgoFooterTwitch = defineAsyncComponent(() => import('./assets/twitch-c615a1a8.mjs').then((r) => r.default));
const LazySvgoFooterTwitter = defineAsyncComponent(() => import('./assets/twitter-03dd3e8d.mjs').then((r) => r.default));
const LazySvgoHeaderDark = defineAsyncComponent(() => import('./assets/dark-2af534b3.mjs').then((r) => r.default));
const LazySvgoHeaderLight = defineAsyncComponent(() => import('./assets/light-249c198a.mjs').then((r) => r.default));
const lazyGlobalComponents = [
  ["SvgoFooterGithub", LazySvgoFooterGithub],
  ["SvgoFooterInsta", LazySvgoFooterInsta],
  ["SvgoFooterLinktree", LazySvgoFooterLinktree],
  ["SvgoFooterSpotify", LazySvgoFooterSpotify],
  ["SvgoFooterTwitch", LazySvgoFooterTwitch],
  ["SvgoFooterTwitter", LazySvgoFooterTwitter],
  ["SvgoHeaderDark", LazySvgoHeaderDark],
  ["SvgoHeaderLight", LazySvgoHeaderLight]
];
...
var invariant = Object.assign(function invariant2(condition, message) {
  ...
  if (!condition) {
    invariant$1(condition, getErrorMsg(message, args));
  }
}, {
...
function getErrorMsg(message, messageArgs) {
  ...
  return global$1[ApolloErrorMessageHandler] && global$1[ApolloErrorMessageHandler](message, args) || "An error occurred! For more details, see the full error text at https://go.apollo.dev/c/err#".concat(encodeURIComponent(JSON.stringify({
    version,
    message,
    args
  })));
...
const NuxtApollo = {
  ...
  clients: { "default": { "httpEndpoint": "https://api-eu-central-1-shared-euc1-02.hygraph.com/v2/cllv044ck07am01t6gle51l5k/master", "authType": null, "authHeader": "Authorization", "connectToDevTools": true, "tokenName": "apollo:default.token", "tokenStorage": "cookie" } }
};
...
const prep = (...args) => {
  ...
  const key = ((_e = args == null ? void 0 : args[0]) == null ? void 0 : _e.key) || hash({ query: print$1(query), variables, clientId });
  const fn = () => {
    var _a2;
...
const layouts = {
  default: () => import('./assets/Default-1560fdca.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./assets/error-404-34bb70fc.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./assets/error-500-6a35fead.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./assets/island-renderer-6cbf2854.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, useRequestFetch as a, useRoute as b, createError as c, useAsyncQuery as d, entry$1 as default, useRouter as e, injectHead as i, navigateTo as n, resolveUnrefHeadInput as r, useAsyncData as u };
